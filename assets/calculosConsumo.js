export const calcularRangosConsumo = (consumo, tarifaId, tarifas) => {
    ...
    else if (consumo <= b + il + im) result = { B: b, IL: il, IM: consumo - b - il };
    else if (consumo <= b + il + im + ih) result = { B: b, IL: il, IM: im, IH: consumo - b - il - im };
    else if (consumo <= b + il + im + ih + h) result = { B: b, IL: il, IM: im, IH: ih, H: consumo - b - il - im - ih };
    else result = { B: b, IL: il, IM: im, IH: ih, H: h, S: consumo - b - il - im - ih - h };
